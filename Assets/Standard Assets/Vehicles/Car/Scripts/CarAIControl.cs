...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        [SerializeField] [Range(0, 1)] private float m_AccelWanderAmount = 0f;                  // how much the cars acceleration will wander
        [SerializeField] private float m_AccelWanderSpeed = 0f;                                 // how fast the cars acceleration wandering will fluctuate
        ...
        private void FixedUpdate()
        {
            if (m_Target == null || !m_Driving)
            {
                ...
                m_CarController.Move(0, 0, -1f, false);
            }
            else
            {
                ...
                m_CarController.Move(steer, accel, accel, false);
